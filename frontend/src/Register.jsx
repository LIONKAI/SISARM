...
export default function Register({ irALogin }) {
  ...
  const manejarRegistro = (e) => {
    ...
    // Aquí luego conectaremos con Django para guardar el usuario
    alert('Función de registro lista en Frontend. ¡Pronto la conectaremos al Backend!');
  };

  // Reutilizamos el tema visual
  const theme = {
